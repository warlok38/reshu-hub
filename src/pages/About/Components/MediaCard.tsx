          ...
          <DialogContent dividers={scroll === 'paper'}>
            ...
            >
              ...
              <span style={{color: 'black'}}>
                <S.TextPoint>
                  <li>Процессорные модули на базе отечественных процессоров: 1906ВМ016 (100 МГц, Leon4, АО «НИИЭТ», Воронеж), 1986ВЕ8Т (100 МГц, ARM, «Миландр», Зеленоград), 1892ВМ12АТ (100 МГц, MIPS, АО НПЦ «ЭЛВИС», Зеленоград).</li>
                  <li> Маршрутизатор SpaceWire (3 порта, скорость до 100Мбит/с</li>
                  <li>Встроенный RMAP-контроллер) на базе ПЛИС К5578ТС094 (АО «ВЗПП-С», Воронеж)</li>
                  <li>Счетчики Гейгера (жесткое β-излучения и γ-излучение)</li>
                  <li>Датчики накопленной дозы на базе различных типов транзисторов</li>
